...
@section("content")
    <div class="p-2 active-cont">
        ...
        <div class="form p-4 mx-auto" style="width: 70%">
            <form id="edit-coupon-form" method="post" action="/admin/update-coupon">
            {{ csrf_field() }}
            ...
            <div class="form-group mt-3">
                ...
                <div class="row">
                    <div class="col-4">
                        <input type="text" class="form-control" name="discount" id="discount" value="{{$coupon->discount}}"oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required>
                    </div>
                    <div class="col-4">
