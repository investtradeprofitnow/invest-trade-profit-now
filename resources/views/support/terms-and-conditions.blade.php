    ...
    <div class="container">
        ...
        <div class="mt-4">
            ...
            <p>
                ...
                <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> provided that all access and use 
        ...
        <div class="mt-4">
            ...
            <p>
                If you do not login at <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> for a 
        ...
        <div class="mt-4">
            ...
            <p>
                ...
                <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> news article, and you shall 
            ...
            <p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> in any manner which 
        ...
        <div class="mt-4">
            ...
            <p>
                ...
                <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> shall have no responsibility to 
        ...
        <div class="mt-4">
            ...
            <p>
                ...
                internet connections used to access <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a>
            </p>
        </div>
        <div class="mt-4">
        ...
        <div class="mt-4">
            ...
            <p>
                ...
                <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> and take to you to external 
                ...
                <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> does not imply endorsement of 
                such a site by <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> or by ITPN. Third 
                party links to <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> are governed by a 
                separate agreement.
            </p>
        </div>
        <div class="mt-4">
        ...
        <div class="mt-4">
            ...
            <p>
                ...
                <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> By using the 
                Information on <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a>
                ...
                <a target="_blank" href="{{config('app.url')}}">{{config('app.url')}}</a> or any other person for the 
